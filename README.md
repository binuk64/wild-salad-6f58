...
```
npm create cloudflare@latest -- --template=cloudflare/templates/wild-salad-6f58
```

A live public deployment of this template is available at [https://wild-salad-6f58.templates.workers.dev](https://wild-salad-6f58.templates.workers.dev)
